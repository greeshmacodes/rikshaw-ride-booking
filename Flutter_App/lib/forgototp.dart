...
class _forgototpsubState extends State<forgototpsub> {
  ...
  final Color lightOrangeColor = const Color(0xFFFFB74D);
              ...
              children: [
                ...
                if (_otpExpirySeconds >= 0)
                  Container(
                    padding: EdgeInsets.symmetric(horizontal: 20, vertical: 10),
                    decoration: BoxDecoration(
                      color: _isOtpExpired ? Colors.red[50] : orangeColor.withValues(alpha: 0.1),
                      borderRadius: BorderRadius.circular(12),
                      border: Border.all(
                        color: _isOtpExpired ? Colors.red[200]! : orangeColor.withValues(alpha: 0.3),
                      ),
                    ),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Icon(
                          _isOtpExpired ? Icons.warning : Icons.timer,
                          color: _isOtpExpired ? Colors.red : orangeColor,
                          size: 20,
                        ),
                        SizedBox(width: 10),
                        Text(
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: (_isLoading || _isOtpExpired) ? null : _verifyOTP,
                    style: ElevatedButton.styleFrom(
                      backgroundColor: _isOtpExpired ? Colors.grey[400]! : orangeColor,
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(12),
                      ),
                      elevation: 2,
